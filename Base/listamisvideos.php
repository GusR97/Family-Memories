  ...
  if($resultado->num_rows>0){
    ...
    echo "
                ...
                <tr>
                  ...
                  <td>
                  <a class='btn btn-labeled btn-info round boton3' style='text-align:center;font-size:22px;' href='ver_video.php?id=".$fila['id_video']."'> <i class='fa fa-eye' aria-hidden='true'></i></a>
                  </td>
                  <td>
                  <a class='btn btn-labeled btn-info round boton3' style='text-align:center;font-size:22px;' href='modificar_video.php?id=".$fila['id_video']."'> <i class='fas fa-pencil-alt'></i></a>
                  </td>
                  <td>
                  <a class='btn btn-labeled btn-info round boton3' style='text-align:center;font-size:22px;' href='eliminarvideo.php?id=".$fila['id_video']."'><i class='fas fa-trash'></i></a>
                  </td>
                </tr>";
              }
